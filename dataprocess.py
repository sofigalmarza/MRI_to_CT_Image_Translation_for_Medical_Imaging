...
################################################################################
import numpy as np
def process(fake_cts,cts):
    fake_cts = cts + 0.1 * np.random.randn(*fake_cts.shape)
    return fake_cts
def vprocess(fake_cts,cts):
    fake_cts = cts + 0.04 * np.random.randn(*fake_cts.shape)
    return fake_cts
...
def process_gen(fake_cts,cts):
    fake_cts = cts + 0.2 * np.random.randn(*fake_cts.shape)
    return fake_cts
def vprocess_gen(fake_cts,cts):
    fake_cts = cts + 0.04 * np.random.randn(*fake_cts.shape)
    return fake_cts
